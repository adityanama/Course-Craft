...
const SubSectionModal = ({ modalData, setModalData, edit = false, view = false, add = false }) => {
            ...
            <div className="my-10 w-11/12 max-w-[700px] rounded-lg border border-richblack-400 bg-richblack-800">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 px-8 py-10">
                    ...
                    <div className="flex flex-col space-y-2">
                        ...
                        />
                        {
                            errors.lectureTitle && <p className="ml-2 text-xs tracking-wide text-pink-200">Lecture Title is
                                required</p>
                        }
                    </div>
                    ...
                    <div className="flex flex-col space-y-2">
                        ...
                        />
                        {
                            errors.lectureDesc && <p className="ml-2 text-xs tracking-wide text-pink-200">Lecture Description is
                                required</p>
                        }
                    </div>
