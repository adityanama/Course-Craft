                        ...
                        <Table className="rounded-xl border border-richblack-800 ">
                            <Thead>
                                <Tr className="flex gap-x-10 rounded-t-md border-b border-b-richblack-800 px-6 py-2">
                                    <Th className="flex-1 text-left text-sm font-semibold uppercase text-richblack-100">Courses</Th>
                                    <Th className="text-left text-sm font-semibold uppercase text-richblack-100">Duration</Th>
                                    <Th className="text-left text-sm font-semibold uppercase text-richblack-100">Price</Th>
                                    <Th className="text-left text-sm font-semibold uppercase text-richblack-100">Actions</Th>
                                </Tr>
                            </Thead>
                                    ...
                                    courses.length === 0 ? (
                                        ...
                                        courses.map((course) => (
                                            <Tr key={course._id} className="flex gap-x-10 border-b border-richblack-800 px-6 py-8">
                                                ...
                                                <Td className="text-md font-medium text-caribbeangreen-200">
                                                    ₹{course.price}
                                                </Td>
                                                <Td className="text-sm font-medium text-richblack-100 ">
                                                    <button
