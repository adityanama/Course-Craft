...
const VideoDetailsSideBar = ({ setReviewModal }) => {
    ...
    useEffect(() => {
        ; (() => {
            ...
            const activeSubSectionId = courseSectionData[currSectionIndex].subSection[currSubSectionIndex]._id
                ...
                <div className="h-[calc(100vh - 5rem)] overflow-y-auto">
                    {
                        courseSectionData.map((section, idx) => (
                            <div onClick={() => setActiveStatus(section._id)} key={idx} className="mt-2 cursor-pointer text-sm text-richblack-5">
                                        ...
                                        <div className="transition-[height] duration-500 ease-in-out">
                                            {
                                                section.subSection.map((topic, idx) => (
                                                    <div key={idx} className={`flex gap-3  px-5 py-2 ${videoBarActive === topic._id
